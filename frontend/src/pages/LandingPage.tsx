        ...
        <div className="app-shell min-h-screen">
            ...
            <main>
                <section className="landing-hero">
                    <div className="mx-auto flex min-h-[640px] w-full max-w-7xl items-end px-4 py-12 md:py-16">
                        <div className="max-w-3xl pb-8">
                            <p className="text-xl font-semibold uppercase text-teal-200 md:text-2xl">
                                PhotoPortal
                            </p>
                            ...
                            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-100">
                                La PhotoPortal, gasesti fotografi si videografi
                                profesionisti care iti pot transforma
                                evenimentul intr-o amintire de neuitat.
                                Platforma noastra te ajuta sa alegi rapid
                                pachetul potrivit pentru nunti, botezuri,
                                aniversari, petreceri sau evenimente corporate.
                            </p>

                            <ul className="mt-4 max-w-2xl list-disc pl-5 text-base leading-7 text-slate-200">
                                <li>
                                    Cu ajutorul specialistilor nostri, fiecare
                                    moment important este surprins cu atentie,
                                    creativitate si profesionalism.
                                </li>
                            </ul>
                            ...
                            <div className="mt-8 flex flex-wrap gap-3">
                                <Link
                                    to={PATHS.LOGIN}
                                    className="rounded-lg bg-white px-5 py-3 font-semibold text-slate-950 hover:bg-slate-100"
                                >
                                    Logare in platforma
                                </Link>
                                ...
                                <Link
                                    to={PATHS.OFFERS}
                                    className="rounded-lg border border-teal-200 px-5 py-3 font-semibold text-teal-100 hover:bg-teal-400/15"
                                >
                                    Vezi catalogul
                                </Link>
                            </div>
                ...
                <section className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                    <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                        {eventImages.map((image) => (
                            <img
                                ...
                                src={image.src}
                                alt={image.alt}
                                className="h-44 w-full rounded-lg object-cover shadow-sm lg:h-40"
                                loading="lazy"
                            />
                        ))}
                    </div>
                    ...
                    <div>
                        <p className="text-lg font-semibold uppercase text-teal-700 md:text-xl">
                            Transformam momentele speciale
                        </p>
                        ...
                        <div className="mt-5 space-y-4 text-base leading-7 text-slate-700">
                            <p>
                                PhotoPortal este o platforma dedicata
                                serviciilor foto si video pentru evenimente
                                importante din viata ta.
                            </p>

                            <p>
                                Colaboram cu specialisti calificati, pasionati
                                de imagine, detalii si emotie.
                            </p>

                            <p>
                                Prin intermediul PhotoPortal, procesul de
                                alegere a unui pachet foto/video devine simplu,
                                rapid si accesibil.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mx-auto w-full max-w-7xl px-4">
                        <div className="max-w-3xl">
                            ...
                            <h2 className="mt-2 text-3xl font-bold text-slate-950">
                                De ce sa alegi PhotoPortal?
                            </h2>

                            <p className="mt-4 text-base leading-7 text-slate-700">
                                PhotoPortal iti ofera acces la fotografi si
                                videografi calificati.
                            </p>
                        </div>
                ...
                <section className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-14 lg:grid-cols-[1fr_420px] lg:items-center">
                    <div>
                        <h2 className="text-3xl font-bold text-slate-950">
                            Pastreaza emotiile evenimentului tau
                        </h2>

                        <p className="mt-4 text-base leading-7 text-slate-700">
                            Momentele frumoase trec repede, dar fotografiile si
                            videoclipurile le pot pastra pentru totdeauna.
                        </p>
